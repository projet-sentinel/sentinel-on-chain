...
module  Oracle.TDAT.ScriptHashList.Policy
            (   mkPolicy
            ,   mkUntypedPolicy
            ,   compiledCode
            )
...
import           Oracle.TDAT.Types                        (TDATAction (..),
                                                           TDATParams (..),
                                                           TDATRefScriptDatum (..))
import           Oracle.ThreatDatabase.Types              (ThreatDatabaseSHListDatum (..))
...
{-|
    ...
    Note:
        ...
        - This code is part of the Plutus-based Threat Database ScriptHash List contract implementations.
-}
    ...
    ,   traceIfFalse "TDAT 1" (builtinDatabaseIndex == databaseIndex)
        =
            case redeemer of
                ...
                MintTDAT
                    |   ThreatDatabaseSHListDatum _ _ _ lastUpdated <- getTxOutInlineDatum $ getThreatDataTxOut threatDatabaseAddress
                        ->
