module Oracle.ThreatDatabase.AddressList.Validator
    (   mkValidator
    ,   mkUntypedValidator
    ,   compiledCode
    )   where
...
{-|
    The 'mkValidator' function is the main validator for the ThreatDatabase address list contract.
    ...
    Example usage:
        mkValidator
            ...
            (ThreatDatabaseAddrListDatum 123 123 [addr_test1wz6pk0g5xtvmdm9n3v58emvnwam0aswqstademgatk396xcrex36g] 1234567890)
            UpdateThreatData
    ...
    ,   traceIfFalse "ThreatDatabase 1" (builtinDatabaseIndex == databaseIndex)
        =
            case (redeemer, datum) of
                ...
                (UpdateThreatData,
                    ThreatDatabaseAddrListDatum tag _ _ lastUpdated )
                        |   ThreatDatabaseAddrListDatum tag' _ _ lastUpdated' <- getTxOutInlineDatum singleScriptOutputUTxO
                            ->
